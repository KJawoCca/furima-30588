...
RSpec.describe Item, type: :model do
  describe '#create' do
    ...
    it "発送までの日数についての情報が選択されていること" do
    ...
    it "価格が9,999,999円より高いと登録できないこと" do
      @item.price = "10000000"
      @item.valid?
